        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    ...
                    <a href="{{url('add-invoice')}}" class="btn btn-primary"><i class="ti ti-square-rounded-plus me-1"></i>New Invoice</a>
                </div>
            </div>
            <!-- End Page Header -->   
                        ...
                        <table class="table border">
                            ...
                            <tbody>
                                @forelse($invoices as $invoice)
                                    <tr>
                                        <td><a href="{{url('invoice-details')}}">#{{ $invoice['invoice'] }}</a></td>
                                        <td>
                                            <div class="d-flex align-items-center">
                                        ...
                                        <td class="text-end">
                                            <div>
                                                ...
                                                <ul class="dropdown-menu p-2">
                                                    <li>
                                                        <a href="{{url('invoice-details')}}" class="dropdown-item d-flex align-items-center"><i class="ti ti-eye me-1"></i>Preview</a>
                                                    </li>  
                                                    <li>
                                                        <a href="{{url('edit-invoice')}}" class="dropdown-item d-flex align-items-center"><i class="ti ti-edit me-1"></i>Edit</a>
                                                    </li>                                       
                                                    <li>
