                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('patient-details')}}" class="avatar me-2">
                                                        <img src="{{asset('build/img/avatars/avatar-23.jpg')}}" alt="patient" class="rounded">
                                                    </a>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('patient-details')}}" class="avatar me-2">
                                                        <img src="{{asset('build/img/avatars/avatar-08.jpg')}}" alt="patient" class="rounded">
                                                    </a>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('patient-details')}}" class="avatar me-2">
                                                        <img src="{{asset('build/img/avatars/avatar-21.jpg')}}" alt="patient" class="rounded">
                                                    </a>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('patient-details')}}" class="avatar me-2">
                                                        <img src="{{asset('build/img/avatars/avatar-55.jpg')}}" alt="patient" class="rounded">
                                                    </a>
                                                    <div>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <a href="{{url('patient-details')}}" class="avatar me-2">
                                                        <img src="{{asset('build/img/avatars/avatar-28.jpg')}}" alt="patient" class="rounded">
                                                    </a>
                                                    <div>
                        ...
                        <div class="card-body">
                            <div class="overflow-auto">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('doctor-details')}}" class="avatar flex-shrink-0">
                                            <img src="{{asset('build/img/doctors/doctor-01.jpg')}}" class="rounded" alt="doctor">
                                        </a>
                                        <div class="ms-2">
                                            <div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('doctor-details')}}" class="avatar flex-shrink-0">
                                            <img src="{{asset('build/img/doctors/doctor-11.jpg')}}" class="rounded" alt="doctor">
                                        </a>
                                        <div class="ms-2">
                                            <div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('doctor-details')}}" class="avatar flex-shrink-0">
                                            <img src="{{asset('build/img/doctors/doctor-06.jpg')}}" class="rounded" alt="doctor">
                                        </a>
                                        <div class="ms-2">
                                            <div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('doctor-details')}}" class="avatar flex-shrink-0">
                                            <img src="{{asset('build/img/doctors/doctor-07.jpg')}}" class="rounded" alt="doctor">
                                        </a>
                                        <div class="ms-2">
                                            <div>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-0">
                                    <div class="d-flex align-items-center">
                                        <a href="{{url('doctor-details')}}" class="avatar flex-shrink-0">
                                            <img src="{{asset('build/img/doctors/doctor-12.jpg')}}" class="rounded" alt="doctor">
                                        </a>
                                        <div class="ms-2">
                                            <div>
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/avatars/avatar-31.jpg')}}" alt="patient" class="rounded">          
                                            </a>
                                            <div>
                                                <h6 class="fs-14 mb-0 fw-medium"><a href="{{url('patient-details')}}">James Carter</a></h6>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('doctor-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/doctors/doctor-01.jpg')}}" alt="patient" class="rounded">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/avatars/avatar-54.jpg')}}" alt="patient" class="rounded">
                                            </a>
                                            <div>
                                                <h6 class="fs-14 mb-0 fw-medium"><a href="{{url('patient-details')}}">Emily Davis</a></h6>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('doctor-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/doctors/doctor-07.jpg')}}" alt="doctor" class="rounded">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/avatars/avatar-38.jpg')}}" alt="patient" class="rounded">
                                            </a>
                                            <div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('doctor-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/doctors/doctor-12.jpg')}}" alt="doctor" class="rounded">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/avatars/avatar-43.jpg')}}" alt="patient" class="rounded">
                                            </a>
                                            <div>
                                                <h6 class="fs-14 mb-0 fw-medium"><a href="{{url('patient-details')}}">Olivia Miller</a></h6>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('doctor-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/doctors/doctor-03.jpg')}}" alt="doctor" class="rounded">
                                            </a>
                                            <div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('patient-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/avatars/avatar-41.jpg')}}" alt="patient" class="rounded">
                                            </a>
                                            <div>
                                                <h6 class="fs-14 mb-0 fw-medium"><a href="{{url('patient-details')}}">David Smith</a></h6>
                                            </div>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <a href="{{url('doctor-details')}}" class="avatar avatar-xs me-2">
                                                <img src="{{asset('build/img/doctors/doctor-15.jpg')}}" alt="doctor" class="rounded">
                                            </a>
                                            <div>
