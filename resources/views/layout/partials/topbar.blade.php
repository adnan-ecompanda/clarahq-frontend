    ...
    <header class="navbar-header">
        <div class="page-container topbar-menu">
            <div class="d-flex align-items-center gap-2">
                ...
                <a href="{{url('index')}}" class="logo">
                    ...
                    <span class="logo-dark">
                        <span class="logo-lg"><img src="{{URL::asset('build/img/logo-dark.svg')}}" alt="dark logo"></span>
                    </span>
                
                    <!-- Logo Sm -->
                    <span class="logo-small">
                        <span class="logo-lg"><img src="{{URL::asset('build/img/logo-small.svg')}}" alt="small logo"></span>
                    </span>
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="header-item">
                    <div class="dropdown me-2">
                        <button class="topbar-link btn" data-bs-toggle="dropdown" data-bs-offset="0,24" type="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{URL::asset('build/img/flags/us.svg')}}" alt="flags" height="16">
                        </button>
                        
                        <div class="dropdown-menu dropdown-menu-end p-2">
                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{URL::asset('build/img/flags/us.svg')}}" alt="flags" class="me-1" height="16"> <span class="align-middle">English</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{URL::asset('build/img/flags/de.svg')}}" alt="flags" class="me-1" height="16"> <span class="align-middle">German</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{URL::asset('build/img/flags/fr.svg')}}" alt="flags" class="me-1" height="16"> <span class="align-middle">French</span>
                            </a>

                            <!-- item-->
                            <a href="javascript:void(0);" class="dropdown-item">
                                <img src="{{URL::asset('build/img/flags/ae.svg')}}" alt="flags" class="me-1" height="16"> <span class="align-middle">Arabic</span>
                            </a>
                        ...
                        <div class="dropdown-menu p-0 dropdown-menu-end dropdown-menu-lg" style="min-height: 300px;">
                            ...
                            <div class="notification-body position-relative z-2 rounded-0" data-simplebar>
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-1">
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="{{URL::asset('build/img/avatars/avatar-28.jpg')}}" class="avatar-md rounded-circle" alt="patient">
                                        </div>
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-2">
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-md rounded-circle" alt="patient">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap border-bottom" id="notification-3">
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="{{URL::asset('build/img/avatars/avatar-12.jpg')}}" class="avatar-md rounded-circle" alt="patient">
                                        </div>
                                        <div class="flex-grow-1">
                                ...
                                <div class="dropdown-item notification-item py-3 text-wrap" id="notification-4">
                                    <div class="d-flex">
                                        <div class="me-2 position-relative flex-shrink-0">
                                            <img src="{{URL::asset('build/img/avatars/avatar-08.jpg')}}" class="avatar-md rounded-circle" alt="patient">
                                        </div>
                                        <div class="flex-grow-1">
                ...
                @if (!Route::is(['layout-dark', 'layout-fullwidth', 'layout-hidden', 'layout-hoverview', 'layout-mini', 'layout-rtl']))
                ...
                <div class="dropdown profile-dropdown d-flex align-items-center justify-content-center">
                    <a href="javascript:void(0);" class="topbar-link dropdown-toggle drop-arrow-none position-relative" data-bs-toggle="dropdown" data-bs-offset="0,22" aria-haspopup="false" aria-expanded="false">
                        <img src="{{URL::asset('build/img/avatars/avatar-31.jpg')}}" width="32" class="rounded-2 d-flex" alt=patient">
                    ...
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-md p-2">
                        ...
                        <div class="d-flex align-items-center bg-light rounded p-2 mb-2">
                            <img src="{{URL::asset('build/img/avatars/avatar-31.jpg')}}" class="rounded-circle" width="42" height="42" alt="patient">
                            <div class="ms-2">
                        ...
                        <!-- Item-->
                        <a href="{{url('general-settings')}}" class="dropdown-item">
