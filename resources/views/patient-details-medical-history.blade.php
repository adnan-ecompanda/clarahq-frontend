<?php $page = 'patient-details-medical-history'; ?>   
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <ul class="nav nav-tabs nav-item-primary border-bottom pb-4 mb-4 d-flex align-items-center gap-2">
                ...
                <li class="nav-item">
                    <a href="{{url('patient-details-medical-history')}}" class="nav-link border rounded fw-semibold active">
                        Medical History
                    </a>
                </li>
                <li class="nav-item">
