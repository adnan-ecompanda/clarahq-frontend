<?php $page = 'patient-details-lab-results'; ?>   
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <!-- tabs start -->
                ...
                <li class="nav-item">
                    <a href="{{url('patient-details-lab-results')}}" class="nav-link border rounded fw-semibold active">
                        Lab Results
                    </a>
                </li>
                <li class="nav-item">
                            ...
                            <tbody>
                                @forelse($patient as $result)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-soft-{{ ['Received' => 'success', 'In Progress' => 'info', 'Pending' => 'warning'][$result['status']] ?? 'warning' }}">
                                                {{ $result['status'] }}
                                            </span>
                                        </td>
                                        <td class="text-end">
