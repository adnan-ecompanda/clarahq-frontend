                            ...
                            <div>
                                <div class="d-flex align-items-center justify-content-between border-bottom p-3">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-57.jpg')}}" alt="user"></span>
                                        <div>
                                ...
                                <div>
                                    ...
                                    <div class="chat-users p-4" data-simplebar>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list active mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-58.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-59.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-60.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-61.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-62.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-63.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list mb-1">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-64.jpg')}}" alt="user"></a>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between rounded p-3 user-list">
                                            <div class="d-flex align-items-center">
                                                <a href="#" class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-65.jpg')}}" alt="user"></a>
                                                <div>
                        ...
                        <div class="flex-fill chat-messages">
                            ...
                            <div class="card border-0 mb-0">
                                ...
                                <div class="card-header d-flex align-items-center justify-content-between flex-wrap row-gap-3 p-3">
                                    <div class="d-flex align-items-center">
                                        <span class="avatar me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-58.jpg')}}" alt="user"></span>
                                        <div>
                                    ...
                                    <div class="message-body p-4" data-simplebar>
                                        <div class="chat-list mb-3">
                                            <div class="d-flex align-items-start">
                                                <span class="avatar online me-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-58.jpg')}}" alt="user"></span>
                                                <div>
                                        ...
                                        <div class="chat-list ms-auto mb-3">
                                            <div class="d-flex align-items-start justify-content-end">
                                                ...
                                                <span class="avatar online ms-2 avatar-rounded flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-57.jpg')}}" alt="user"></span>
                                            </div>
                                        </div>
                                        <div class="chat-list mb-3">
                                            <div class="d-flex align-items-start">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="message-box receive-message p-3">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                <span class="bg-white d-block rounded p-1"><img src="{{URL::asset('build/img/social/attachment-03.jpg')}}" class="rounded" alt="attachment"></span>
                                                                <span class="bg-white d-block rounded p-1"><img src="{{URL::asset('build/img/social/attachment-04.jpg')}}" class="rounded" alt="attachment"></span>
                                                            </div>
                                                        </div>
                                                        <div class="ms-2">
                                                            <a href="javascript:void(0);" data-bs-toggle="dropdown"><i class="ti ti-dots-vertical"></i></a>
