                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded" alt="rounded">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded-top" alt="rounded-top">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded-end" alt="rounded-end">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded-bottom" alt="rounded-bottom">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded-start" alt="rounded-start">
                                <img src="{{URL::asset('build/img/avatars/avatar-39.jpg')}}" class="avatar-lg rounded-circle" alt="rounded-circle">
                                <img src="{{URL::asset('build/img/avatars/avatar-37.jpg')}}" class="avatar-lg w-auto rounded-pill" alt="rounded-pill">
                            </div>
                ...
                <div class="col-xl-6">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-start flex-wrap gap-2">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-0" alt="rounded-0">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-1" alt="rounded-1">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-2" alt="rounded-2">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-3" alt="rounded-3">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-4" alt="rounded-4">
                                <img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" class="avatar-lg rounded-5" alt="rounded-5">
                            </div>
                        </div> <!-- end card body -->
                    </div> <!-- end card -->
                </div> <!-- end col -->
