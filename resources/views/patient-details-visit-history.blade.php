<?php $page = 'patient-details-visit-history'; ?>   
    ...
    <div class="page-wrapper">
            ...
            <div class="content">
                ...
                <ul class="nav nav-tabs nav-item-primary border-bottom pb-4 mb-4 d-flex align-items-center gap-2">
                    ...
                    <li class="nav-item">
                        <a href="{{url('patient-details-visit-history')}}" class="nav-link border rounded fw-semibold active">
                           Visit History
                        </a>
                    </li>
                    <li class="nav-item">
                                ...
                                <tbody>
                                    @forelse($patient as $visit)
                                        <tr>
                                            ...
                                            <td>
                                            <span class="badge badge-soft-{{ ['Completed' => 'success', 'Inprogress' => 'purple'][$visit['status']] ?? 'warning' }}">
                                                {{ $visit['status'] }}
                                            </span>
                                            </td>
                                            <td class="text-end">
