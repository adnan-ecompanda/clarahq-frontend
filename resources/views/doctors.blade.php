        ...
        <div class="content">
            ...
            <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                ...
                <div class="gap-2 d-flex align-items-center flex-wrap">
                    <a href="{{url('doctors')}}" class="btn btn-icon btn-white active" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="Grid" data-bs-original-title="Grid View"><i class="ti ti-layout-grid"></i></a>
                    <a href="{{url('all-doctors-list')}}" class="btn btn-icon btn-white" data-bs-toggle="tooltip" data-bs-placement="top" aria-label="List" data-bs-original-title="List View"><i class="ti ti-layout-list"></i></a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-01.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Andrew Clark</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-03.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Katherine Brooks</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-04.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Benjamin Harris</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-05.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Laura Mitchell</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-06.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Christopher Lewis</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-07.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Natalie Foster</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-10.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Jonathan Adams</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-08.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Rebecca Scott</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-12.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Samuel Turner</a></h6>
                ...
                <div class="col-xxl-3 col-xl-4 col-lg-6 d-flex">
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                <span class="avatar avatar-xl online avatar-rounded">
                                    <a href="{{url('doctor-details')}}"><img src="{{URL::asset('build/img/doctors/doctor-11.jpg')}}" alt="doctor"></a>
                                </span>
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Victoria Evans</a></h6>
                    ...
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                ...
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Daniel Foster</a></h6>
                                <span class="fs-14">Ophthalmologist</span>
                            </div>
                            <div class="border p-1 px-2 rounded mb-3">
                                    <div class="row">
                    ...
                    <div class="card shadow flex-fill w-100 mb-0">
                        <div class="card-body">
                            ...
                            <div class="text-center mb-3">
                                ...
                                <h6 class="mt-2 mb-1"><a href="{{url('doctor-details')}}">Dr. Amelia Scott</a></h6>
