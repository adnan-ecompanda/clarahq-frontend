                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{URL::asset('build/img/avatars/avatar-03.jpg')}}" alt="image" class="img-fluid rounded-circle" width="133">
                                            <p class="mb-0">
                                        ...
                                        <div class="col-sm-3">
                                            <img src="{{URL::asset('build/img/avatars/avatar-02.jpg')}}" alt="image" class="img-thumbnail rounded-pill" width="133">
                                            <p class="mb-0">
