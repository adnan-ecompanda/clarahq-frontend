                    ...
                    <div class="row g-0">
                        <div class="col-lg-3 col-md-4">
                            <div class="p-4 pb-0 pb-sm-4 mail-sidebar" data-simplebar>
                                <div>
                                    <div class="mb-3">
                                    <a href="{{url('email-compose')}}" class="btn btn-primary w-100"><i class="ti ti-square-rounded-plus me-1"></i>Compose New</a>
                                    </div>
                                        ...
                                        <div class="accordion-item mb-3 pb-3">
                                            ...
                                            <div id="flush-collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionFlushExample">
                                                <div class="nav flex-column mt-2">
                                                    <a href="{{url('email')}}" class="d-flex text-start align-items-center fw-medium fs-14 bg-light rounded p-2 mb-1"><i class="ti ti-inbox me-2"></i>Inbox<span class="avatar avatar-xs ms-auto bg-danger rounded-circle">6</span></a>
                                            ...
                                            <table class="table border-0 w-100">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-29.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Sarah, me (7)</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 mb-1"><a href="{{url('email-details')}}">[Reminder] Client Meeting at 3 PM Today</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-28.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Mike, team (5)</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 mb-1"><a href="{{url('email-details')}}">Submit Project Proposal</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-33.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Anna</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 d-flex fw-normal align-items-center mb-1"><a href="{{url('email-details')}}">Team Outing Next Friday</a><span class="badge bg-info ms-2">Markting</span></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-30.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Tom</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 d-flex align-items-center mb-1"><a href="{{url('email-details')}}">[Update] New Design Guidelines Available</a><span class="badge bg-warning ms-2">Client</span></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-43.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Lisa</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 fw-normal mb-1"><a href="{{url('email-details')}}">[Event] Webinar on Social Media Strategy</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-31.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Jason, me (9)</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 mb-1"><a href="{{url('email-details')}}">[Reminder] Sales Targets Review</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-48.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Emily</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 fw-normal d-flex align-items-center mb-1"><a href="{{url('email-details')}}">[Alert] System Maintenance Scheduled</a><span class="badge bg-success ms-2">Personal</span></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-34.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Kevin</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 mb-1"><a href="{{url('email-details')}}">Expense Reports Due</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-50.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Rachel</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 fw-normal mb-1"><a href="{{url('email-details')}}">Beta Testing</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-35.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">David</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 fw-normal mb-1"><a href="{{url('email-details')}}">[Reminder] Contract Renewals</a></h6>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="d-flex align-items-center gap-2">
                                                                <a href="{{url('email-details')}}" class="avatar avatar-sm"><img src="{{URL::asset('build/img/avatars/avatar-51.jpg')}}" alt="user"></a>
                                                                <p class="fs-14 mb-0"><a href="{{url('email-details')}}">Nina, me (9)</a></p>
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div>
                                                                <h6 class="fs-14 fw-normal mb-1"><a href="{{url('email-details')}}">[Notice] Policy Changes</a></h6>
