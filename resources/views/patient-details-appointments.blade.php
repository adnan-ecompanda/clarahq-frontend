<?php $page = 'patient-details-appointments'; ?>   
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <!-- tabs start -->
                ...
                <li class="nav-item">
                    <a href="{{url('patient-details-appointments')}}" class="nav-link border rounded fw-semibold active">
                        Appointments
                    </a>
                </li>
                <li class="nav-item">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-nowrap">                        
                        <table class="table mb-0 border">
                            ...
                            <tbody>
                                @forelse($patient as $appointment)
                                    <tr>
                                        ...
                                        <td>
                                            <span class="badge badge-soft-{{ ['Upcoming' => 'purple', 'Completed' => 'success'][$appointment['status']] ?? 'info' }}">
                                                {{ $appointment['status'] }}
                                            </span>
                                        </td>
                                        <td class="text-end">
