                                    ...
                                    <tbody>
                                            ...
                                            <th scope="row">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm me-2 online avatar-rounded">
                                                        <img src="{{URL::asset('build/img/avatars/avatar-01.jpg')}}" alt="img">
                                                    </span>Mark
                                                </div>
                                            </th>
                                        ...
                                        <tr>
                                            <th scope="row">
                                                <div class="d-flex align-items-center">
                                                    <span class="avatar avatar-sm me-2 online avatar-rounded">
                                                        <img src="{{URL::asset('build/img/avatars/avatar-04.jpg')}}" alt="img">
                                                    </span>Larry
                                                </div>
                                            </th>
                                    ...
                                    <tbody>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md me-2 avatar-rounded">
                                                        <img src="{{URL::asset('build/img/avatars/avatar-03.jpg')}}" alt="img">
                                                    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar avatar-md me-2 avatar-rounded">
                                                        <img src="{{URL::asset('build/img/avatars/avatar-06.jpg')}}" alt="img">
                                                    </div>
