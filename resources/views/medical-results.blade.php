                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive table-nowrap">
                        <table class="table mb-0 border">
                            ...
                            <tbody>
                                @forelse($medicalResults as $result)
                                    <tr>
                                        <td><a href="#" data-bs-toggle="modal" data-bs-target="#view_modal">{{ $result['id'] }}</a></td>
                                        <td>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="7" class="text-center">No medical results found</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
