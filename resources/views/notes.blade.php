                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-01.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-02.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-03.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-04.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-05.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-06.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-07.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-08.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-09.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-10.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-11.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
                                        ...
                                        <div class="card flex-fill">
                                            <div class="card-body">
                                                ...
                                                <div class="d-flex align-items-center justify-content-between">
                                                    ...
                                                    <a href="javascript:void(0);" class="avatar avatar-sm">
                                                        <img src="{{URL::asset('/./build/img/avatars/avatar-12.jpg')}}" alt="Profile" class="img-fluid">
                                                    </a>
                                                </div>
                                            </div> <!-- end card body -->
                                        </div> <!-- end card -->
