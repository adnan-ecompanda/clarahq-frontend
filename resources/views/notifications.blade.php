                            ...
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                <div class="d-flex align-items-center">
                                    <a href="{{url('patient-details')}}" class="avatar flex-shrink-0">
                                        <img src="{{URL::asset('/./build/img/avatars/avatar-28.jpg')}}" alt="patient" class="rounded-circle">
                                    </a>
                                    <div class="ms-2">
                                        <div>
                                            <p class="mb-1"><a href="{{url('patient-details')}}" class="fw-medium">John Doe</a> added new  patient <a href="{{url('appointments')}}" class="fw-medium">appointment booking</a></p>
                    ...
                    <div class="card notication-card mb-3">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                <div class="d-flex align-items-center">
                                    <a href="{{url('patient-details')}}" class="avatar flex-shrink-0">
                                        <img src="{{URL::asset('/./build/img/avatars/avatar-30.jpg')}}" alt="patient" class="rounded-circle">
                                    </a>
                                    <div class="ms-2">
                                        <div>
                                            <p class="mb-1"><a href="{{url('patient-details')}}" class="fw-medium">Thomas William</a> booked a new appointment.</p>
                    ...
                    <div class="card notication-card mb-3">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                <div class="d-flex align-items-center">
                                    <a href="{{url('patient-details')}}" class="avatar flex-shrink-0">
                                        <img src="{{URL::asset('/./build/img/avatars/avatar-29.jpg')}}" alt="patient" class="rounded-circle">
                                    </a>
                                    <div class="ms-2">
                                        <div>
                                            <p class="mb-1"><a href="{{url('patient-details')}}" class="fw-medium">Sarah Anderson</a> has been successfully booked for <span class="text-dark fw-medium">April 5 at 10:00 AM.</span></p>
                    ...
                    <div class="card notication-card mb-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                                <div class="d-flex align-items-center">
                                    <a href="{{url('patient-details')}}" class="avatar flex-shrink-0">
                                        <img src="{{URL::asset('/./build/img/avatars/avatar-31.jpg')}}" alt="patient" class="rounded-circle">
                                    </a>
                                    <div class="ms-2">
                                        <div>
                                            <p class="mb-1"><a href="{{url('patient-details')}}" class="fw-medium">Ann McClure</a> cancelled her appointment scheduled for <span class="text-dark fw-medium">February 5, 2024</span></p>
