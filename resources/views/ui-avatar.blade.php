                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <span class="avatar avatar-xss me-2">
                                <img src="{{URL::asset('build/img/avatars/avatar-02.jpg')}}" alt="avatar">
                            </span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <span class="avatar avatar-xs me-2 online avatar-rounded">
                                <img src="{{URL::asset('build/img/avatars/avatar-03.jpg')}}" alt="avatar">
                            </span>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="avatar-list-stacked avatar-group-lg mb-3">
                                <span class="avatar">
                                    <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-04.jpg')}}" alt="avatar">
                                </span>
                                <span class="avatar">
                                    <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-04.jpg')}}" alt="avatar">
                                </span>
                        ...
                        <div class="card-body">
                            <div class="avatar-list-stacked avatar-group-lg mb-3">
                                <span class="avatar avatar-rounded">
                                    <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-05.jpg')}}" alt="avatar">
                                </span>
                                <span class="avatar avatar-rounded">
                                    <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-05.jpg')}}" alt="avatar">
                                </span>
