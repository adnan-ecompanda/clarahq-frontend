                            ...
                            <div class="p-4">
                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center overflow-hidden">
                                                <span class="avatar flex-shrink-0">
                                                    <img src="{{URL::asset('build/img/avatars/avatar-01.jpg')}}" alt="user" class="rounded-circle">
                                                </span>
                                    ...
                                    <div class="bg-light p-3 text-center rounded">
                                        <div class="mb-3"><img src="{{URL::asset('build/img/icons/file-manager-bg.svg')}}" alt="file-manager-bg"></div>
                                                ...
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{URL::asset('build/img/icons/dropbox.svg')}}" alt="user">
                                        ...
                                        <div class="col-md-4 col-sm-6 d-flex">
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{URL::asset('build/img/icons/drive.svg')}}" alt="user">
                                        ...
                                        <div class="col-md-4 col-sm-6 d-flex">
                                            <div class="card flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <div class="d-flex align-items-center">
                                                            <img src="{{URL::asset('build/img/icons/cloud.svg')}}" alt="user">
                                    ...
                                    <div class="row justify-content-center">
                                        ...
                                        <div class="col-md-3 col-sm-6 d-flex">
                                            <div class="card position-relative flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <img src="{{URL::asset('build/img/icons/file.svg')}}" alt="user">
                                        ...
                                        <div class="col-md-3 col-sm-6 d-flex">
                                            <div class="card position-relative flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <img src="{{URL::asset('build/img/icons/pdf-icon.svg')}}" alt="user">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="dropdown">
                                                                <a href="javascript:void(0);" class="fs-16" data-bs-toggle="dropdown">
                                                                    <i class="ti ti-dots-vertical"></i>
                                        ...
                                        <div class="col-md-3 col-sm-6 d-flex">
                                            <div class="card position-relative flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <img src="{{URL::asset('build/img/icons/image.svg')}}" alt="user">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="dropdown">
                                                                <a href="javascript:void(0);" class="fs-16" data-bs-toggle="dropdown">
                                                                    <i class="ti ti-dots-vertical"></i>
                                        ...
                                        <div class="col-md-3 col-sm-6 d-flex">
                                            <div class="card position-relative flex-fill">
                                                <div class="card-body">
                                                    <div class="d-flex align-items-center justify-content-between mb-3">
                                                        <img src="{{URL::asset('build/img/icons/folder-icon.svg')}}" alt="user">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="dropdown">
                                                                <a href="javascript:void(0);" class="fs-16" data-bs-toggle="dropdown">
                                                                    <i class="ti ti-dots-vertical"></i>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="avatar avatar-sm bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview">
                                                            <img src="{{URL::asset('build/img/icons/file-01.svg')}}" class="img-fluid w-auto h-auto" alt="user"></a>
                                                        <div class="ms-2">
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked avatar-group-sm">
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-03.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-04.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-12.jpg')}}" alt="user">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="avatar avatar-sm bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview">
                                                            <img src="{{URL::asset('build/img/icons/file-02.svg')}}" class="img-fluid w-auto h-auto" alt="user"></a>
                                                        <div class="ms-2">
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked avatar-group-sm">
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-15.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-16.jpg')}}" alt="user">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="avatar avatar-sm bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview">
                                                            <img src="{{URL::asset('build/img/icons/file-03.svg')}}" class="img-fluid w-auto h-auto" alt="user"></a>
                                                        <div class="ms-2">
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked avatar-group-sm">
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-02.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-03.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-05.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-06.jpg')}}" alt="user">
                                                        </span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="avatar avatar-sm bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview">
                                                            <img src="{{URL::asset('build/img/icons/file-04.svg')}}" class="img-fluid w-auto h-auto" alt="user"></a>
                                                        <div class="ms-2">
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked avatar-group-sm">
                                                        ...
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-10.jpg')}}" alt="user">
                                                        </span>
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-15.jpg')}}" alt="user">
                                                        </span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <a href="#" class="avatar avatar-sm bg-light" data-bs-toggle="offcanvas" data-bs-target="#preview">
                                                            <img src="{{URL::asset('build/img/icons/file-05.svg')}}" class="img-fluid w-auto h-auto" alt="user"></a>
                                                        <div class="ms-2">
                                                ...
                                                <td>
                                                    <div class="avatar-list-stacked avatar-group-sm">
                                                        ...
                                                        <span class="avatar avatar-rounded">
                                                            <img class="border border-white" src="{{URL::asset('build/img/avatars/avatar-11.jpg')}}" alt="user">
                                                        </span>
                                                    </div>
                                                </td>
                                                <td>
