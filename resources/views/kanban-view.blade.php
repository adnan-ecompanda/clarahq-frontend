                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="avatar-list-stacked avatar-group-sm me-3">
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-10.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-08.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-07.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                            ...
                            <div class="card kanban-card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="avatar-list-stacked avatar-group-sm me-3">
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-13.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-14.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-15.jpg')}}" alt="user">
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="javascript:void(0);" class="d-flex align-items-center me-2"><i class="ti ti-message me-1"></i>0</a>
                            ...
                            <div class="card kanban-card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="avatar-list-stacked avatar-group-sm me-3">
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-20.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-21.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-22.jpg')}}" alt="user">
                                            </span>
                            ...
                            <div class="card kanban-card mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="avatar-list-stacked avatar-group-sm me-3">
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-23.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-24.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-25.jpg')}}" alt="user">
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="avatar-list-stacked avatar-group-sm me-3">
                                            ...
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-26.jpg')}}" alt="user">
                                            </span>
                                            <span class="avatar avatar-rounded">
                                                <img src="{{URL::asset('build/img/avatars/avatar-27.jpg')}}" alt="user">
                                            </span>
                                        </div>
                                        <div class="d-flex align-items-center gap-2">
                                            <a href="javascript:void(0);" class="d-flex align-items-center me-2"><i class="ti ti-message me-1"></i>10</a>
