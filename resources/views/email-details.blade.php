                    ...
                    <div class="row g-0">
                        <div class="col-lg-3">
                            <div class="p-4 pb-0 pb-lg-4 mail-sidebar" data-simplebar>
                                <div>
                                    <div class="mb-3">
                                        <a href="{{url('email-compose')}}" class="btn btn-primary btn-lg w-100"><i class="ti ti-square-rounded-plus me-1"></i>Compose New</a>
                                    </div>
                                    ...
                                    <div class="mail-message-view p-4" data-simplebar>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom flex-wrap flex-md-nowrap row-gap-2 pb-3">
                                            <div class="d-flex align-items-center flex-wrap">
                                                <span class="avatar me-2 flex-shrink-0"><img src="{{URL::asset('build/img/avatars/avatar-28.jpg')}}" alt="user"></span>
                                                <div>
                                        ...
                                        <div class="border-top mt-3 pt-3 mb-3">
                                            ...
                                            <div class="d-flex align-items-center flex-wrap gap-3">
                                                <div class="card flex-shrink-0 mb-0">
                                                    <div class="card-body p-3">
                                                        <div class="card-img mb-3">
                                                            <img src="{{URL::asset('build/img/social/attachment-01.jpg')}}" class="rounded" alt="attachemnt">
                                                        </div>
                                                ...
                                                <div class="card flex-shrink-0 mb-0">
                                                    <div class="card-body p-3">
                                                        <div class="card-img mb-3">
                                                            <img src="{{URL::asset('build/img/social/attachment-02.jpg')}}" class="rounded" alt="attachemnt">
                                                        </div>
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            <div>
