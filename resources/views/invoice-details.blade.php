            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    ...
                    <div class="d-flex align-items-center justify-content-between gap-2 mb-4 flex-wrap">
                        <h6 class="mb-0"><a href="{{url('invoice')}}"><i class="ti ti-arrow-left me-2"></i>Invoice</a></h6>
                            ...
                            <div class="bg-light rounded p-3 mb-3">
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <div class="invoice-logo">
                                        <img src="{{URL::asset('build/img/logo-dark.svg')}}" class="logo-white" alt="logo">
                                ...
                                <div class="row align-items-center gy-4">
                                    ...
                                    <div class="col-lg-2">
                                        <div class="text-end">
                                            <div><img src="{{URL::asset('build/img/icons/qr-code.svg')}}" alt="qr-code" class="img-fluid"></div>
                                        </div>
                                    </div> <!-- end col -->
